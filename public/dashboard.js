class Dashbaord extends React.Component {
  ...
  renderTeachers() {
    ...
    ReactDOM.render(<ManageTeachers />, mainContainer);
  }
  renderStudents() {
    const mainContainer = document.querySelector("#mainContainer");
    ReactDOM.render(<ManageStudents />, mainContainer);
  }

  renderDashBoard() {}
  renderDepartment() {
    const mainContainer = document.querySelector("#mainContainer");
    ReactDOM.render(<ManageDepartment />, mainContainer);
  }
  componentDidMount() {
      ...
      <React.Fragment>
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark shadow fixed-top">
          <a className="navbar-brand pl-3" href="#">
            <div className="row">
              <h4>MOBILE GRADING SYSTEM</h4>
            </div>
            <div className="row">
              <small>University of Antique</small>
            </div>
          </a>
          <button
        ...
        <div className="row w-100 bg-white h-100">
          ...
          <div className="col-2 position-fixed h-100 pt-5">
            <div
              ...
              role="tablist"
            >
              <h5 className="p-2 text-white">CONTROL PANEL</h5>
              {/* <a
              ...
              >
                <div className="row">
                  <div className="col-3">
                    <img className="w-75" src="assets/images/school.png" />
                  </div>
              ...
              >
                <div className="row">
                  <div className="col-3">
                    <img className="w-75" src="assets/images/instructor.png" />
                  </div>
